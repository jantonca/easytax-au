...
import { usePreviewCsvImport } from './use-csv-preview';
...
describe('usePreviewCsvImport', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('should successfully preview CSV import', async () => {
    const mockResponse = {
    ...
    const { result } = renderHook(() => usePreviewCsvImport(), {
    ...
    expect(fetchCall[0]).toBe('http://localhost:3000/import/expenses/preview');
