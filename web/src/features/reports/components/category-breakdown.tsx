...
function BasLabelBadge({ label }: { label: string }): ReactElement {
  return (
    <span className="inline-flex items-center rounded-md bg-slate-200 px-2 py-0.5 text-xs font-medium text-slate-700 dark:bg-slate-700/50 dark:text-slate-300">
      {label}
    </span>
  );
}
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950/40">
              <th scope="col" className="px-4 py-3 font-medium text-slate-900 dark:text-slate-300">
                Category
              </th>
              <th scope="col" className="px-4 py-3 font-medium text-slate-900 dark:text-slate-300">
                BAS Label
              ...
              <th
                scope="col"
                className="px-4 py-3 text-right font-medium text-slate-900 dark:text-slate-300"
              >
                Total
              </th>
              <th
          ...
          <tbody>
            {sortedCategories.map((category) => (
              <tr
                ...
                className="border-b border-slate-200/50 transition-colors hover:bg-slate-100 dark:border-slate-800/50 dark:hover:bg-slate-800/30"
              >
            ...
            {/* Totals Row */}
            <tr className="border-t-2 border-slate-300 bg-slate-100 font-semibold dark:border-slate-700 dark:bg-slate-800/40">
