      ...
      <table className="w-full border-collapse bg-white dark:bg-slate-950 text-xs">
        <thead>
          <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900">
            ...
            <th className="p-2 text-left">
              <span className="font-medium text-slate-700 dark:text-slate-300">Deductible</span>
            </th>
            <th className="p-2 text-left">
        ...
        <tbody>
          {sorted.map((category) => (
            ...
            >
              <td className="p-2 text-slate-900 dark:text-slate-200">{category.name}</td>
              <td className="p-2">
                <span
                  className="inline-flex items-center rounded-full bg-slate-200 dark:bg-slate-800 px-2 py-0.5 text-[10px] font-medium text-slate-700 dark:text-slate-300"
              ...
              <td className="p-2">
                {category.isDeductible ? (
                  ...
                  <span
                    className="inline-flex items-center rounded-full bg-red-100 dark:bg-red-900/50 px-2 py-0.5 text-[10px] font-medium text-red-700 dark:text-red-300"
