      ...
      <table className="w-full border-collapse bg-white dark:bg-slate-950 text-xs">
        <thead>
          <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900">
            ...
            <th className="p-2 text-left">
              <span className="font-medium text-slate-700 dark:text-slate-300">ABN</span>
            </th>
            <th className="p-2 text-left">
              <button
                onClick={() => {
        ...
        <tbody>
          {sorted.map((client) => {
            ...
            return (
              ...
              >
                <td className="p-2 text-slate-900 dark:text-slate-200">{client.name}</td>
                <td className="p-2 text-slate-600 dark:text-slate-400">{formatAbn(client.abn)}</td>
                <td className="p-2">
                  {client.isPsiEligible ? (
                    <span
                      className="inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/50 px-2 py-0.5 text-[10px] font-medium text-amber-700 dark:text-amber-300"
                    ...
                    <span
                      className="inline-flex items-center rounded-full bg-slate-200 dark:bg-slate-800 px-2 py-0.5 text-[10px] font-medium text-slate-600 dark:text-slate-400"
                ...
                <td className="p-2 text-slate-600 dark:text-slate-400">
                  {incomeCount > 0 ? (
                    <span className="text-slate-900 dark:text-slate-200">{incomeCount}</span>
                  ) : (
                    <span>0</span>
                  )}
                </td>
